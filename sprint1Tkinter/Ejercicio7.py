...
def crear():
    ...
    if xa > 300 or ya > 300 or xb > 300 or yb > 300 or xa < 0 or ya < 0 or xb < 0 or yb < 0:
        label_error.config(text="Error, algún valor fuera de rango (Rango de 0 a 300)")
    else:
        canvas.create_rectangle(xa, ya, xb, yb, width=1, outline='black')
